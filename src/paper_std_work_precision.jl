...
using DifferentialEquations, ProgressMeter, DelimitedFiles, JSON
using LinearAlgebra, SparseArrays, BenchmarkTools, Symbolics
...
res_path = joinpath(parentDirectory(@__DIR__), "results", "std_work_precision")
...
# external - IRKGaussLegendre (fails)
